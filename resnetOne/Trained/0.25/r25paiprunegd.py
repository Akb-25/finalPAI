...
def main():
    ...
    excel_path = f"results25PAIGDPrunePretrain.xlsx"
    ...
    torch.save(model, f"models25PAIGDPrunePretrain/{pruningTimes}_pruned_model.pth")
    pruningTimes += 1
    ...
    while(continue_pruning==True):
        ...
        if(continue_pruning==True):
            ...
            torch.save(model, f"models25PAIPrunePretrain/{pruningTimes}_pruned_model.pth")
            pruningTimes += 1
            # exit(1)
